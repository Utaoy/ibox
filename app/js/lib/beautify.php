...
define('TK_UNKNOWN',       4);
define('TK_WORD',          5);
define('TK_START_EXPR',    6);
define('TK_END_EXPR',      7);
define('TK_START_BLOCK',   8);
define('TK_END_BLOCK',     9);
define('TK_END_COMMAND',   10);
define('TK_EOF',           11);
define('TK_STRING',        12);

define('TK_BLOCK_COMMENT', 13);
define('TK_COMMENT',       14);

define('TK_OPERATOR',      15);

// internal flags
define('PRINT_NONE',       16);
define('PRINT_SPACE',      17);
define('PRINT_NL',         18);
